...
document.querySelector(".cards-container").innerHTML = profilesCards;

/* Theme switcher (light/dark) */
const body = document.body;
const toggleBtn = document.querySelector(".theme-switcher-btn");
...
function updateBtn(theme) {
	toggleBtn.innerHTML = theme === "light" ? `<i class="ri-moon-line"></i> DARK` : `<i class="ri-sun-line"></i> LIGHT`;
}

// For returning users
let prevTheme = getTheme();
if (prevTheme) {
	updateBtn(prevTheme);
	body.classList.add(prevTheme);
} else {
	setTheme("light");
}
